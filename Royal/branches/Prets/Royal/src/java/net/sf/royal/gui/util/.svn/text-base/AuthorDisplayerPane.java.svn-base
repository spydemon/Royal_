...
public class AuthorDisplayerPane extends JPanel {
	...
	/**
	 * Create a new ImageLabel corresponding to the type
	 * @param type If -1 then create a label with no image @see AuthorLine
	...
	/**
	 * This class represents an author. It is used by the AuthorDisplayerPane
	 * to design it in a GUI.
	 * 
	 * @author Steveo
	 *
	 */
	public static class AuthorLine
	{
		...
		private String name;
		/**
		 * The state represents the several jobs of the Author
		 */
		private int state;
		
		/**
		 * Create a new AuthorLine with a Author
		 * @param au The Author
		 */
