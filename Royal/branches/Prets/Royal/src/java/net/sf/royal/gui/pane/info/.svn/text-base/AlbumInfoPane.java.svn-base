...
public class AlbumInfoPane extends AbstractInfoPane
{
	...
	private void init()
	{
		...
		this.jtfDimension = createTextField();
		...
		this.changeGridProperties(COMPONENT);
		this.gbc.gridwidth = 1;
		this.jtfTomeNumber = createTextField();
		...
		this.gbc.gridx++;
		this.changeGridProperties(COMPONENT);
		this.jtfCollection = createTextField();
		...
		this.changeGridProperties(COMPONENT);
		this.gbc.gridwidth = 1;
		this.jtfPurchase = createTextField();
		...
		this.gbc.gridx ++;
		this.changeGridProperties(COMPONENT);
		this.jtfRelease = createTextField();
		...
		this.jtaDesc.setEditable(false);
		this.jtaDesc.setBackground(super.getColor());
		this.add(this.jtaDesc, this.gbc);
		
		/**** Preter une bande dessinee
		this.gbc.gridx = 0;
		this.gbc.gridy++;
		this.changeGridProperties(LABEL);
	...
	public void update(Album a) {
		...
		this.jtfPurchase.setText(d==null ? "" : LocaleManager.getInstance().getTextDate(d, true));
		
		/**** Release date ****/
		d = this.album.getRegistration();
		this.jtfRelease.setText(d==null ? "" : LocaleManager.getInstance().getTextDate(d, true));
		...
		/**** Comment ****/
		this.jtaDesc.setText(this.album.getComment());
