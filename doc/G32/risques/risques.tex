...
\endhead
	...
	\multicolumn{9}{||c||}{\rowcolor{gray} \color{white}Paramètres généraux} \\
\hline
...
\hline 
	...
	\multicolumn{9}{||c||}{\rowcolor{gray} \color{white}Paramètres liés aux utilisateurs} \\
\hline
...
\hline
	...
	\multicolumn{9}{||c||}{\rowcolor{gray} \color{white}Paramètres liés à la maitrise d'ouvrage} \\
\hline
...
\newpage
	\multicolumn{9}{||c||}{\rowcolor{gray} \color{white}Paramètres liées à la maitrise d'œuvre} \\
\hline
